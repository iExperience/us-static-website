...
jQuery(document).ready(function ($){
	...
	$('.ilightbox-member-8').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	$('.ilightbox-member-9').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	...
	$('.ilightbox-member-11').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	$('.ilightbox-member-12').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	$('.ilightbox-member-13').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	$('.ilightbox-member-14').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
	$('.ilightbox-member-15').iLightBox({
		skin: 'dark',
		path: 'vertical'
	});
});
